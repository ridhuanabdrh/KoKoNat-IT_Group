...
<form method="post" action="<?php echo($_SERVER['PHP_SELF'])?>">
    ...
    <div class="form-group">
        ...
        <input type="text" name="course" class="form-control" placeholder="e.g: BSE" required>
    </div>

    <div class="form-group">
        <label for="semester"> Semester </label>
        <input type="text" name="semester" class="form-control" placeholder="e.g: 6" required>
    </div>
...
if(isset($_POST['register']) && !empty($_POST['email'])){
    ...
    $query = "INSERT INTO user(`fullname`, `email`, `class`, `role`, `course`, `semester`) VALUES('".$name."', '".$email."', '".$class."', '".$role."', '".$course."', '".$semester."')";
